 ...
 */
export const Get_Desired_Type_Of_Tasks = (tasks: Task[]): Task[] => {
 ...
 * @param {Task} task 
 */
export const Reward_Completed_On_Time = (task: Task): void => {
 ...
 * @param {Task} task 
 */
export const Punish_Incompleted_On_Time = (task: Task): void => {
 ...
 */
export const printSummary = (taskLog: string): void => {
  // Log Tasks
  if (taskLog) console.log(taskLog);
};
